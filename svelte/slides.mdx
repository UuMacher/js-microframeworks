...
* always unsubscribe to avoud memory leaks
...
* __onDestroy__: runs when the componed is unmounted
...
<CodeSurfer
  ...
  dark={true}
  steps={[
        { range: [22, 25], notes: "Mutiple components sharing one store" },
        { lines: [3], notes: "The Store is imported" },
        { lines: [3, 22], notes: "The store can be used in the template" },
        { lines: [2], range: [10, 18], notes: "Lifecycle methods" },
        { ranges : [[15, 19], [23, 27]], notes: "Each blocks" },
        { notes: "That's it!" }
  ]}
/>
